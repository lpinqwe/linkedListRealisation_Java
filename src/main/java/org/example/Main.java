...
public class Main {
    public static void main(String[] args) {
        ...
        list.add(new Example(0, "a", "+2112"));
        list.add(new Example(1, "a", "+2112"));
        list.add(new Example(2, "b", "+2112"));
        list.add(new Example(3, "c", "+2112"));
        list.add(new Example(4, "d", "+2112"));
        list.add(new Example(5, "e", "+2112"));
        list.reverse();
